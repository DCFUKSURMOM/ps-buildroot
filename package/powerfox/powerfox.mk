...
POWERFOX_POST_EXTRACT_HOOKS += POWERFOX_PREPARE_MOZCONFIG

ifeq ($(BR2_i386)$(BR2_x86_64),y)
    POWERFOX_DEPENDENCIES += host-yasm
endif

define POWERFOX_PREPARE_MOZCONFIG
    cp -v $(POWERFOX_PKGDIR)/mozconfig $(@D)/.mozconfig
...
define POWERFOX_BUILD_CMDS
    cd $(@D) && git clone https://github.com/Jazzzny/platform-uxp platform/
    cd $(@D) && $(TARGET_MAKE_ENV) ./mach build
endef

define POWERFOX_INSTALL_TARGET_CMDS
